...
if(isset($_POST['search']['value']))
{
	...
	$sql .= " WHERE service_id like '%".$search_value."%'";
	$sql .= " OR service_name like '%".$search_value."%'";
